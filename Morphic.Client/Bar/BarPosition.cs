namespace Morphic.Client.Bar
{
    ...
    public class BarPosition
    {
        ...
        /// </summary>
        /// <param name="workArea">The workarea for the window.</param>
        ...
        {
            Rect result = new Rect(new Point(), size);

            result.X = this.GetAbsolute(workArea.Left, workArea.Right, this.X, this.XIsRelative);
            result.Y = this.GetAbsolute(workArea.Top, workArea.Bottom, this.Y, this.YIsRelative);
